...
#define AT_PIN_Set() IO_RB8_SetHigh()
#define AT_PIN_Clear() IO_RB8_SetLow()
...
#define AT_COMMAND_RESET_INDEX 0
#define AT_COMMAND_ORGL_INDEX 1
//#define AT_COMMAND_ADDR ("+ADDR", 5)
#define AT_COMMAND_NAME_INDEX 2
#define AT_COMMAND_RNAME_INDEX 3
#define AT_COMMAND_ROLE_INDEX 4
#define AT_COMMAND_STATE_INDEX 5
#define AT_COMMAND_INQM_INDEX 6
#define AT_COMMAND_MRAD_INDEX 7
#define AT_COMMAND_DISC_INDEX 8
