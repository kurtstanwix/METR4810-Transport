...
#define MS_TIMER_TMR_REGISTER PREPROCESSOR_STITCH(TMR, MS_TIMER_TMR)
#define MS_TIMER_PR_REGISTER PREPROCESSOR_STITCH(PR, MS_TIMER_TMR)
#define MS_TIMER_TxCON_REGISTER PREPROCESSOR_STITCH(T, PREPROCESSOR_STITCH(MS_TIMER_TMR, CON))
#define MS_TIMER_TxCONbits PREPROCESSOR_STITCH(MS_TIMER_TxCON_REGISTER, bits)
#define MS_TIMER_TxIF PREPROCESSOR_STITCH(_T, PREPROCESSOR_STITCH(MS_TIMER_TMR, IF))
#define MS_TIMER_TxIE PREPROCESSOR_STITCH(_T, PREPROCESSOR_STITCH(MS_TIMER_TMR, IE))
#define MS_TIMER_TxInterrupt PREPROCESSOR_STITCH(_T, PREPROCESSOR_STITCH(MS_TIMER_TMR, Interrupt))
